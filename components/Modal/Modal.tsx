...
export default function Modal({ isOpen, toggleModal }: Props) {
    return isOpen ? (
        <div className="fixed top-0 w-full h-screen snap-none bg-black/40 z-50 flex flex-col items-center justify-center">
            <div className="border border-red-400 rounded-lg bg-white w-2/3 sm:w-96 h-32 flex flex-col items-center justify-between py-2 px-2">
                ...
                <span className="flex flex-row justify-between">
                    ...
                    <button className="px-2 py-1 border border-red-500 rounded-lg mb-1">
                        Cancel
                    </button>
                </span>
            </div>
